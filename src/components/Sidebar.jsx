      ...
      <div className="flex flex-col px-6 py-3 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <span className="text-lg uppercase tracking-wide leading-none px-3 py-2 rounded inline-block" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 800, color: '#fef6ff', background: 'linear-gradient(135deg, #74439c 0%, #a6348c 100%)' }}>
